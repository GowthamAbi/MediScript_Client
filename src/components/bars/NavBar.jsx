...
export default function NavBar() {
  return (
    <>
   <nav className='flex gap-8 py-6 justify-around items-center  mx-auto bg-white '>
    <div><h1 className='text-2xl '>MediScript</h1></div>
    <div className='inline-flex items-center gap-2 bg-blue-100  w-auto px-2 rounded-2xl'>
